...
external fun getBadgeBackgroundColor(details: TabDetails, callback: (result: dynamic /* "TupleType" kind unsupported yet here! (node_modules/@types/chrome/index.d.ts:451:22 to 451:55) */) -> Unit): Unit = definedExternally
